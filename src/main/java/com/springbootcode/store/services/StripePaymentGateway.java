...
import com.springbootcode.store.entities.OrderItem;
...
public class StripePaymentGateway implements PaymentGateway {
    ...
    @Override
    public Optional<PaymentResult> parseWebhokRequest(WebhookRequest request) {
        try {
    ...
    private  Long extractOrderId(Event event){
        var stripeObject = event.getDataObjectDeserializer().getObject().orElseThrow(
                ()-> new PaymentException("Could not deserialze stripe event. check sdk and api version. ")
        );
